...
public final class BulkDictionaryDataEsPlayerMain {
  ...
  public static void main(String[] args) {
    if (args.length < 7) {
      System.out
          .println("Usage: esBaseUrl esIndexName esTypeName bulkSize eventsCount dictionaryFile fieldName:type [fieldName:type] ...");
      System.out.println("The following types are available:");
      System.out.println(" * text");
      System.out.println(" * numeric");
      System.out.println(" * date");
      System.out.println("Example: http://localhost:9200 dashboard post 10 100 someFile.txt id:numeric title:text");
      System.exit(1);
    }
    ...
    PlayerConfig config = new PlayerConfig(SimpleSourceFactory.SOURCE_CLASS_CONFIG_KEY,
        ...
        fields.toString(), PlayerRunner.SINK_CLASS_CONFIG_KEY, BulkJSONDataESSink.class.getName(),
        SimpleJSONDataESSink.ES_BASE_URL_KEY, esBaseUrl, SimpleJSONDataESSink.ES_INDEX_NAME_KEY, esIndexName,
        SimpleJSONDataESSink.ES_TYPE_NAME_KEY, esTypeName, BulkJSONDataESSink.ES_BATCH_SIZE_KEY, bulkSize);
